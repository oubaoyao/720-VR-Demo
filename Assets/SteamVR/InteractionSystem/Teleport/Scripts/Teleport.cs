...
{
    public delegate void RoomNameHandler(string msg);
    //-------------------------------------------------------------------------
    public class Teleport : MonoBehaviour
    {
        ...
        public static event RoomNameHandler roomNameDelegate;
		...
		private void TeleportPlayer()
		{
            ...
            Debug.Log("Move==="+ pointedAtTeleportMarker.transform.GetComponent<TeleportPoint>().title);
            roomNameDelegate(pointedAtTeleportMarker.transform.GetComponent<TeleportPoint>().title);
        }
